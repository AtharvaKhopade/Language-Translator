...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages  = {"From","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech",
    "Welish","Hindi","Urdu"};

    String[] toLanguages  = {"To","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech",
            "Welish","Hindi","Urdu"};
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sourceEdit.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(MainActivity.this, "Please select the language to make transition", Toast.LENGTH_SHORT).show();
                }
                else{
